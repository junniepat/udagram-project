...
### Each Folder is a project of it's own, the concept is that they're all microservices and not a monolith.

### e.g cd udagram-frontend and run the below command, replicate the same process for every folder to run them.

Each folder has it's travis.yml and docker files
